...
/**
    ...
    public static String chartOfAccounts="src/default_xml/chart-of-accounts.xml";
    public static String reportingDates="/default_xml/reporting-dates.xml";
    public static String customerList="src/default_xml/customer-list.xml";
    public static String supplierList="src/default_xml/supplier-list.xml";
    public static String accountCategories="/default_xml/account-categories.xml";
